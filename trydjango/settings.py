...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-c773e^f)k-t71_c4+)r16^j%x7t0171gpwodx1apy-gygi2=&#')
...
TEMPLATES = [
    {
        ...
        '/home/joao/projetos/djangoprojects/try_django_course/templates',
